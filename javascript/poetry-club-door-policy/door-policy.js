...
export function frontDoorPassword(word) {
  ...
  const remainingLettersLowerCase = remainingLetters.join("").toLowerCase()

  return `${firstLetterUpperCase}${remainingLettersLowerCase}`
}
...
export function backDoorResponse(line) {
  ...
  return frontDoorResponse(reversedLine)
}
